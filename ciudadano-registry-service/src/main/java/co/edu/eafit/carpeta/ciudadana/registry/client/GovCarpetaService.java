...
public class GovCarpetaService {
    ...
    public GovCarpetaService(GovCarpetaClient govCarpetaClient) {
        ...
        try {
            ...
            return GovCarpetaResponse.builder()
                    .codigoRespuesta(response.getStatusCode().value())
                    .exitoso(response.getStatusCode() == HttpStatus.OK || response.getStatusCode() == HttpStatus.CREATED || response.getStatusCode() == HttpStatus.NO_CONTENT)
                    .mensaje(response.getBody())
                    .build();
        } catch (Exception e) {
    ...
    public GovCarpetaResponse registrarCiudadanoFallback(RegistrarCiudadanoRequest request, Exception ex) {
    ...
    public GovCarpetaResponse desregistrarCiudadanoFallback(DesregistrarCiudadanoRequest request, Exception ex) {
