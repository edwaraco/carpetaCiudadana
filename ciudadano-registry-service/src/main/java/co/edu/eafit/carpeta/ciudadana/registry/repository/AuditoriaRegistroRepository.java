...
public interface AuditoriaRegistroRepository {
    ...
    List<AuditoriaRegistro> findByAccionOrderByFechaAccionDesc(AuditoriaRegistro.AccionAuditoria accion);

    List<AuditoriaRegistro> findByFechaAccionBetween(LocalDateTime fechaInicio, LocalDateTime fechaFin);

    List<AuditoriaRegistro> findByCedulaAndAccion(Long cedula, AuditoriaRegistro.AccionAuditoria accion);
}
