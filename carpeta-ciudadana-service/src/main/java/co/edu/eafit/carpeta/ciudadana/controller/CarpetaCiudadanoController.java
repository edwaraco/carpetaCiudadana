...
@Tag(
    ...
    description =
        "API para gestión de carpetas ciudadanas y documentos. "
...
public class CarpetaCiudadanoController {
  ...
  @Operation(
      ...
      description =
          "Crea una carpeta ciudadana única para un ciudadano. "
  ...
  @Operation(
      ...
      description =
          "Obtiene la información completa de una carpeta ciudadana utilizando su ID único.",
      tags = {"Carpeta Ciudadana"})
  @ApiResponses(
      value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
  ...
  @Operation(
      ...
      description =
          "Obtiene la información de una carpeta ciudadana utilizando la cédula del propietario. "
  ...
  public ResponseEntity<ApiResponse<CarpetaResponse>> buscarCarpetaPorCedula(
    ...
    return carpetaService
        .buscarCarpetaPorCedula(request)
        .map(ResponseUtil::toCarpetaResponse)
        .map(ResponseUtil::ok)
  ...
  @Operation(
      ...
      description =
          "Almacena un documento en la carpeta ciudadana. "
  ...
  public ResponseEntity<ApiResponse<SubirDocumentoResponse>> subirDocumento(
      ...
      @Parameter(
              description = "Contexto del documento",
              required = true,
              example = "EDUCACION",
              schema =
                  @Schema(
  ...
  @Operation(
      ...
      description =
          "Obtiene los metadatos completos de un documento específico de la carpeta. "
  ...
  public ResponseEntity<ApiResponse<DocumentoResponse>> obtenerDocumento(
      @Parameter(description = "ID de la carpeta", required = true) @PathVariable String carpetaId,
      @Parameter(description = "ID del documento", required = true) @PathVariable
          String documentoId) {
  ...
  @Operation(
      ...
      description =
          "Lista todos los documentos almacenados en la carpeta ciudadana. "
  ...
  public ResponseEntity<ApiResponse<List<DocumentoResponse>>> obtenerDocumentosCarpeta(
    ...
    List<DocumentoResponse> documentos =
        carpetaService.obtenerDocumentosCarpeta(request).stream()
            .map(ResponseUtil::toDocumentoResponse)
            .toList();
  ...
  @Operation(
      ...
      description =
          "Genera una URL temporal y segura (prefirmada) para descargar un documento específico. "
  ...
  public ResponseEntity<ApiResponse<DocumentoUrlResponse>> generarUrlDescarga(
    ...
    DocumentoResponse documento =
        carpetaService
            ...
            .orElseThrow(
                () ->
                    new co.edu.eafit.carpeta.ciudadana.exception.ResourceNotFoundException(
                        "Documento", "documentoId", documentoId));

    String urlDescarga = carpetaService.generarUrlDescarga(carpetaId, documentoId);

    DocumentoUrlResponse response =
        DocumentoUrlResponse.of(documentoId, documento.titulo(), urlDescarga, 15);
