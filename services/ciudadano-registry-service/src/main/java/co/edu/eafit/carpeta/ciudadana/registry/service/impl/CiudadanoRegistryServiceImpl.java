...
public class CiudadanoRegistryServiceImpl implements CiudadanoRegistryService {
  ...
  public CiudadanoRegistryServiceImpl(
      RegistroCiudadanoRepository registroRepository,
  ...
  public ValidacionCiudadanoResponse validarCiudadano(Long cedula) {
    ...
    try {
      ...
      if (registroRepository.findActiveByCedula(cedula).isPresent()) {
        ...
        registrarAuditoria(
            cedula,
            AuditoriaRegistro.AccionAuditoria.VALIDACION_CIUDADANO,
            null,
            null,
      ...
      registrarAuditoria(
          cedula,
          AuditoriaRegistro.AccionAuditoria.ERROR_VALIDACION,
          null,
          null,
          "Error interno",
          500,
  ...
  public RegistroCiudadanoResponse registrarCiudadano(RegistrarCiudadanoRequest request) {
    ...
    try {
      ...
      if (govResponse.getCodigoRespuesta() == 501) {
        log.warn(
            "Ciudadano {} ya está registrado en GovCarpeta: {}",
            request.getCedula(),
            govResponse.getMensaje());
        registrarAuditoria(
            request.getCedula(),
            AuditoriaRegistro.AccionAuditoria.REGISTRO_CIUDADANO,
            null,
            null,
            "Ciudadano ya registrado en GovCarpeta",
            govResponse.getCodigoRespuesta(),
            govResponse.getMensaje());
      ...
      if (!govResponse.getExitoso()) {
        log.error(
            "Error registrando ciudadano {} en GovCarpeta: {}",
            request.getCedula(),
            govResponse.getMensaje());
        registrarAuditoria(
            request.getCedula(),
            AuditoriaRegistro.AccionAuditoria.ERROR_REGISTRO,
            null,
            null,
            "Error en GovCarpeta",
            govResponse.getCodigoRespuesta(),
        ...
        throw new ExternalServiceException(
            "GovCarpeta", govResponse.getMensaje(), govResponse.getCodigoRespuesta());
      }
  ...
  public RegistroCiudadanoResponse desregistrarCiudadano(DesregistrarCiudadanoRequest request) {
    ...
    try {
      RegistroCiudadano registro =
          registroRepository
              .findActiveByCedula(request.getCedula())
              .orElseThrow(
                  () -> new ResourceNotFoundException("Ciudadano", "cedula", request.getCedula()));
      ...
      if (!govResponse.getExitoso()) {
        log.error(
            "Error desregistrando ciudadano {} en GovCarpeta: {}",
            request.getCedula(),
            govResponse.getMensaje());
        registrarAuditoria(
            request.getCedula(),
            AuditoriaRegistro.AccionAuditoria.ERROR_DESREGISTRO,
            null,
            null,
            "Error en GovCarpeta",
            govResponse.getCodigoRespuesta(),
      ...
      registrarAuditoria(
          request.getCedula(),
          AuditoriaRegistro.AccionAuditoria.DESREGISTRO_CIUDADANO,
          null,
          null,
          "Desregistro exitoso",
          govResponse.getCodigoRespuesta(),
  ...
  public RegistroCiudadanoResponse obtenerCiudadanoPorCedula(Long cedula) {
    return registroRepository.findActiveByCedula(cedula).map(this::mapToResponse).orElse(null);
  }

  @Override
  public List<RegistroCiudadanoResponse> obtenerTodosCiudadanos() {
    return registroRepository.findAllActive().stream()
  ...
  public List<AuditoriaRegistroResponse> obtenerHistorialAuditoria(Long cedula) {
    return auditoriaRepository.findByCedulaCiudadanoOrderByFechaAccionDesc(cedula).stream()
  ...
  public String crearCarpetaCiudadana(Long cedula) {
    ...
    try {
      ...
      if (response == null || !response.getExitoso()) {
        log.error(
            "Error creando carpeta ciudadana para cédula {}: {}",
            cedula,
      ...
      registrarAuditoria(
          cedula,
          AuditoriaRegistro.AccionAuditoria.CREACION_CARPETA,
          null,
          null,
