...
public class CarpetaCiudadanaService {
  ...
  public CarpetaCiudadanaResponse crearCarpeta(CrearCarpetaRequest request) {
    ...
    try {
      ResponseEntity<CarpetaCiudadanaApiResponse> response =
          carpetaCiudadanaClient.crearCarpeta(request);
      log.info(
          "Respuesta creación carpeta para cédula {}: {}",
          request.getCedula(),
      ...
      if (apiResponse != null && apiResponse.getSuccess() && apiResponse.getData() != null) {
        ...
        return CarpetaCiudadanaResponse.builder()
            ...
            .data(
                CarpetaCiudadanaResponse.CarpetaData.builder()
  ...
  public CarpetaCiudadanaResponse buscarCarpetaPorCedula(String cedula) {
    ...
    try {
      ResponseEntity<CarpetaCiudadanaApiResponse> response =
          carpetaCiudadanaClient.buscarCarpetaPorCedula(cedula);
  ...
  public CarpetaCiudadanaResponse crearCarpetaFallback(CrearCarpetaRequest request, Exception ex) {
    log.warn(
        "Circuit Breaker activado para crearCarpeta. Cedula: {}, Error: {}",
        request.getCedula(),
        ex.getMessage());
    return CarpetaCiudadanaResponse.builder()
        .codigoRespuesta(503)
  ...
  public CarpetaCiudadanaResponse buscarCarpetaPorCedulaFallback(String cedula, Exception ex) {
    log.warn(
        "Circuit Breaker activado para buscarCarpetaPorCedula. Cedula: {}, Error: {}",
        cedula,
        ex.getMessage());
    return CarpetaCiudadanaResponse.builder()
        .codigoRespuesta(503)
