...
public class CiudadanoRegistryController {
  ...
  @Operation(
      ...
      description =
          "Valida si un ciudadano está disponible para registro en el sistema. "
  ...
  public ResponseEntity<ApiResponse<ValidacionCiudadanoResponse>> validarCiudadano(
      @Parameter(
              description = "Cédula del ciudadano a validar",
              required = true,
              example = "1234567890")
          @PathVariable
          Long cedula) {
  ...
  public ResponseEntity<ApiResponse<RegistroCiudadanoResponse>> registrarCiudadano(
      @io.swagger.v3.oas.annotations.parameters.RequestBody(
          ...
          @Valid
          @RequestBody
          RegistrarCiudadanoRequest request) {
  ...
  @Operation(
      ...
      description =
          "Desregistra un ciudadano del sistema. "
  ...
  public ResponseEntity<ApiResponse<RegistroCiudadanoResponse>> desregistrarCiudadano(
      @io.swagger.v3.oas.annotations.parameters.RequestBody(
          ...
          @Valid
          @RequestBody
          DesregistrarCiudadanoRequest request) {
  ...
  @Operation(
      ...
      description =
          "Obtiene el historial completo de auditoría de un ciudadano, "
  ...
  public ResponseEntity<ApiResponse<List<AuditoriaRegistroResponse>>> obtenerHistorialAuditoria(
    ...
    List<AuditoriaRegistroResponse> response =
        ciudadanoRegistryService.obtenerHistorialAuditoria(cedula);
