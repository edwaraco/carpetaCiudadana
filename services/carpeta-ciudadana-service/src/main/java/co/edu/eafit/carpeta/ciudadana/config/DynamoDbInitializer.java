...
public class DynamoDbInitializer implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    List<String> tablas = Arrays.asList("CarpetaCiudadano", "Documento", "HistorialAcceso");
  ...
  private void crearTablaSiNoExiste(String nombreTabla) {
    try {
      ...
      DescribeTableRequest describeRequest =
          DescribeTableRequest.builder().tableName(nombreTabla).build();
    ...
    switch (nombreTabla) {
        ...
        return CreateTableRequest.builder()
            ...
            .attributeDefinitions(
                AttributeDefinition.builder()
                    ...
                    .build())
            .keySchema(
                KeySchemaElement.builder().attributeName("carpetaId").keyType(KeyType.HASH).build())
      ...
      case "HistorialAcceso":
        return CreateTableRequest.builder()
            ...
            .keySchema(
                KeySchemaElement.builder().attributeName("carpetaId").keyType(KeyType.HASH).build(),
                KeySchemaElement.builder().attributeName("accesoId").keyType(KeyType.RANGE).build())
            .billingMode(BillingMode.PAY_PER_REQUEST)
            .build();
  ...
  private void esperarTablaActiva(String nombreTabla) {
    try {
      WaiterResponse<DescribeTableResponse> waiterResponse =
          dynamoDbClient
              .waiter()
              .waitUntilTableExists(DescribeTableRequest.builder().tableName(nombreTabla).build());
