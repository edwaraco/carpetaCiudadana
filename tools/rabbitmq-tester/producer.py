...
def interactive_mode(channel):
    ...
    while True:
        ...
        print("\n" + "-"*60)
        print(f"[SUMMARY] Success: {success_count}/{count}, Failed: {count - success_count}/{count}")
...
def main():
    ...
    try:
        ...
        if args.queue:
            ...
            print("\n" + "-"*60)
            print(f"[SUMMARY] Success: {success_count}/{args.count}, Failed: {args.count - success_count}/{args.count}")
        else:
            # Interactive mode
